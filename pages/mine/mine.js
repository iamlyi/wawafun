...
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.status == 200) {
          ...
          me.setData({
            faceUrl: faceUrl,
            fansCounts: userInfo.fansCounts == undefined || userInfo.fansCounts == null || userInfo.fansCounts == '' ? 0 : userInfo.fansCounts,
            followCounts: userInfo.followCounts == undefined || userInfo.followCounts == null || userInfo.followCounts == '' ? 0 : userInfo.followCounts,
            receiveLikeCounts: userInfo.receiveLikeCounts == undefined || userInfo.receiveLikeCounts == null || userInfo.receiveLikeCounts == '' ? 0 : userInfo.receiveLikeCounts,
  ...
  followMe: function (e) {
    ...
    var followType = e.currentTarget.dataset.formtype;
